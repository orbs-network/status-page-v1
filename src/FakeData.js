const isValidTimeRef = new Date().toISOString();
const isValidEthereumAddress = "0xff56cc6b1e6ded347aa0b7676c85ab0b3d08b0fa";
const isValidImageVersion = "orbsnetwork/management-service:v100.0.0";
const isValidBlock = "4497649";
